...
class IOSPublishMaterialsDownloader
{
    ...
    public function DownloadIOSPublishMaterialsZip()
    {
        ...
        $IOS_authInfo = IOS_authInfo::where('project_id', $project_id)->find();
        ...
        // 将认证信息保存为 JSON 文件
        $authFilePath = $this->createAuthInfoFile($tempDir, $iosAuth);
        // 添加认证信息文件到 ZIP 根目录
     ...
     * 创建认证信息文件
     */
    private function createAuthInfoFile($tempDir, $iosAuth)
    {
        $iosAuthInfo = [
