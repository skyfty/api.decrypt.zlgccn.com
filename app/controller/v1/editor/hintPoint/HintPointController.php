...
class HintPointController
{
    ...
    public function save()
    {
        ...
        try {
            ...
            return success($findHintPoint, '更新成功');
    ...
    private function saveCondition($findHintPoint, $condition)
    {
        ...
        $findCondition = HintPointCondition::where('hint_point_id', $findHintPoint->id)->find() ?? new HintPointCondition();
        $findCondition->hint_point_id = $findHintPoint->id;
        $findCondition->condition = $condition['condition'];
        $findCondition->operator = $condition['operator'];
        $findCondition->value = $condition['value'];
        $findCondition->save();
    }   
