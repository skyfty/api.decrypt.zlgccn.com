...
namespace app\controller\v2\editor\auth;

use think\facade\Db;
use app\model\ButtonPoint\ButtonPointLocalizationText;
use app\controller\v1\editor\hintPoint\HintPointController;
    ...
    public function index()
    {
        ...
        foreach ($project_list as &$project) {
            ...
            foreach ($city_list as $k => $city) {
                ...
                foreach ($room_list as $k2 => $room) {
                    // 创建控制器实例
                    $hintPointController = app()->make(\app\controller\v2\editor\hintPoint\HintPointController::class);
                    $hint_point_list = $hintPointController->index($room['id']);
